...
public class Team {
    ...
    public Team(UltraSkyWars plugin, Game game, String path, int id) {
        ...
        friendly = plugin.getVc().getNameTag(getName() + "FR", "friendly", "§a");
        fire = plugin.getVc().getNameTag(getName() + "FI", "fire", "§c");
    }
    ...
    public void reset() {
        ...
        chest = new GameChest(false, chests);
        friendly.deleteTeam(getName() + "FR");
        fire.deleteTeam(getName() + "FI");
        friendly = plugin.getVc().getNameTag(getName() + "FR", "friendly", "§a");
        fire = plugin.getVc().getNameTag(getName() + "FI", "fire", "§c");
    }
    ...
    public void removeMember(Player p) {
        members.remove(p);
        center.remove(p);
        friendly.deleteTeam(p, getName() + "FR");
        fire.deleteTeam(p, getName() + "FI");
    }
