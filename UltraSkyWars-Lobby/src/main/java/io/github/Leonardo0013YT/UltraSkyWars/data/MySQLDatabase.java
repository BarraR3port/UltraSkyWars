...
public class MySQLDatabase implements Database {
    ...
    private static final String SAVE = "UPDATE UltraSkyWars SET Data=?, Kills=?, Wins=?, Deaths=?, Coins=?, Elo=? WHERE UUID=?";
    private static final HashMap<UUID, SWPlayer> players = new HashMap<>();
