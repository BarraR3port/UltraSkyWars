...
public class DependUtils {
    ...
    public void loadDepends() {
        ...
        try {
            ...
            File io = new File(plugin.getDataFolder(), "libs/commons-io-2.8.0.jar");
            if (!io.exists()) {
                this.download(new URL("https://repo1.maven.org/maven2/commons-io/commons-io/2.8.0/commons-io-2.8.0.jar"), "commons-io-2.8.0.jar");
            } else {
                loadJarFile(io);
            }
            try {
