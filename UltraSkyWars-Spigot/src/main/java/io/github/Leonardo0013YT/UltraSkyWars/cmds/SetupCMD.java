...
public class SetupCMD implements CommandExecutor {
    ...
    private void sendHelp(CommandSender s) {
        ...
        new FancyMessage("§b/sws pluginblock cubelets/soulwell  §7- §eJoin on plugin of cubelet/soulwell block.").setHover(HoverEvent.Action.SHOW_TEXT, "§fClick to execute!").setClick(ClickEvent.Action.SUGGEST_COMMAND, "/sws pluginblock ").build().send(s);
